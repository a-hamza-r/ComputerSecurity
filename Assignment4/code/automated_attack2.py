...
if __name__ == "__main__":
    ...
    iv_and_ctext = b'f6836f3bf7c8e04565d6dc133e0cac98203233e879b2af9c9d106c2ddc99ace892b154c3e3331569172026403864070cbe770dbaa6a368d3b35f1bcd76dfb7feb11af3c864b45a4605d30739bc88ac7d649bad1fcbd3d40716b05afc239f61ed'
    length = len(iv_and_ctext)
    cyphers = [iv_and_ctext[i:i+16] for i in range(0, length, 16)]
    plaintexts = []

    oracle = PaddingOracle('128.186.120.189', 21505)
    ...
    for i in range(len(cyphers)-1, 0, -1):
        ...
        for K in range(1,17):
            ...
            for i in range(256):
                print("checking CC1[{}] as: {}".format(16-K, i))
                CC1[16 - K] = i
